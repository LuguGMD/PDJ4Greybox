...
{
    //[CreateAssetMenu(fileName = "PlayerStrategyAmanda", menuName = "Scriptable Objects/PlayerStrategyAmanda")]
    public class PlayerStrategyAmanda : PlayerStrategyScriptable
    {
