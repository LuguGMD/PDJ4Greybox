...
{
    //[CreateAssetMenu(fileName = "PlayerStrategyRori", menuName = "Scriptable Objects/PlayerStrategyRori")]
    public class PlayerStrategyRori : PlayerStrategyScriptable
    {
        private PlayerStrategyHandler.Strategy m_strategy = PlayerStrategyHandler.Strategy.Rori;
